...
<head>
    ...
    <link rel="stylesheet" href="../css/IntercambioFotos.css">
</head>
<div id="cms-root"></div>
<body>
     <div id="original-content">
          ...
          <!-- Hero Section -->
          <section class="hero-gallery editable-image" style="background-image: url('FOTOS/fotosIntercambio/avion-fondo.jpg'); background-size: cover; background-position: center;">
