...
<body>
    ...
    <?php 
        $hockey = [
            ...
            'info_p1' => ['es'=>'El hockey sobre césped es un deporte de precisión y habilidad técnica que requiere coordinación, velocidad y estrategia. En nuestra institución, este deporte ha demostrado ser excelente para desarrollar la concentración y el trabajo en equipo.','en'=>'Field hockey is a precision and technical skill sport that requires coordination, speed and strategy. At our institution, this sport has proven excellent for developing concentration and teamwork.','it'=>'L\'hockey su prato è uno sport di precisione e abilità tecnica che richiede coordinazione, velocità e strategia. Nella nostra istituzione, questo sport si è dimostrato eccellente per sviluppare concentrazione e lavoro di squadra.'],
            ...
            <section class="sport-info">
                <div class="sport-info-grid">
                    ...
                    <div class="sport-info-image">
                        <img src="FOTOS/fotosDeportes/hockey1.jpg" alt="Hockey Scuola Italiana">
                    </div>
                </div>
            </section>
            ...
            <section class="sport-gallery">
                ...
                <div class="gallery-grid">
                    <div class="gallery-item">
                        <img src="FOTOS/fotosDeportes/hockey1.jpg" alt="Hockey 1">
                    </div>
                    <div class="gallery-item">
                        <img src="FOTOS/fotosDeportes/hockey2.png" alt="Hockey 2">
                    </div>
                    <div class="gallery-item">
                        <img src="FOTOS/fotosDeportes/hockey1.jpg" alt="Hockey 3">
                    </div>
                </div>
            </section>
        </div>
