    ...
    <main class="main-content">
        ...
        <?php 
            $ba = [
                ...
                'sec1' => [
                    'es' => 'Promovemos el trabajo cooperativo, la interdisciplinariedad, la reflexión, estrategias metacognitive y la autonomía en el estudio, para que el alumno sea independiente en la adquisición de nuevos saberes.',
        ...
        <section class="content-sections">
            <div class="content-row">
                ...
                <div class="image-content right">
                    <img src="FOTOS/fotosClases/bachillerato2.jpg" alt="Actividades Bachillerato">
                </div>
            </div>
            <div class="content-row reverse">
                <div class="image-content left">
                    <img src="FOTOS/fotosClases/bachillerato3.jpg" alt="Objetivos">
                </div>
            ...
            <div class="content-row">
                ...
                <div class="image-content right">
                    <img src="FOTOS/fotosClases/bachillerato4.jpg" alt="Doble titulación">
                </div>
            </div>
            <div class="content-row reverse">
                <div class="image-content left">
                    <img src="FOTOS/fotosClases/bachillerato5.jpg" alt="Proyecto educativo">
                </div>
                <div class="text-content right">
