...
<body>
    <div id="original-content"> 
     <!-- Navigation -->
          ...
          <!-- Hero Section -->
          <section class="hero-gallery editable-image" style="background-image: url('FOTOS/fotosIntercambio/argentina.jpg'); background-size: cover; background-position: center;">
