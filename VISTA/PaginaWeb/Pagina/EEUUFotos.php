...
<head>
    ...
    <title>EEUU fotos</title>
    <link rel="stylesheet" href="breadcrumbs.css">
    <link rel="stylesheet" href="../css/EEUUFotos.css">
...
<body>
    <div id="original-content">
     <!-- Navigation -->
          ...
          <!-- Hero Section -->
          <section class="hero-gallery editable-image" style="background-image: url('FOTOS/fotosIntercambio/EEUU.jpg'); background-size: cover; background-position: center;">
