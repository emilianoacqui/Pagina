...
<body>
    ...
    <?php 
        $futbol = [
            ...
            'info_p2' => ['es'=>'Nuestros equipos participan activamente en competencias locales e regionales, representando con orgullo los colores de la Scuola Italiana. Los entrenamientos se realizan en nuestras modernas instalaciones deportivas, donde los estudiantes pueden desarrollar su técnica y táctica bajo la supervisión de entrenadores calificados.','en'=>'Our teams actively participate in local and regional competitions, proudly representing the colors of Scuola Italiana. Training sessions are held in our modern sports facilities, where students can develop their technique and tactics under the supervision of qualified coaches.','it'=>'Le nostre squadre partecipano attivamente a competizioni locali e regionali, rappresentando con orgoglio i colori della Scuola Italiana. Gli allenamenti si svolgono nelle nostre moderne strutture sportive, dove gli studenti possono sviluppare la loro tecnica e tattica sotto la supervisione di allenatori qualificati.'],
